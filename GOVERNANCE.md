...
`cloud-itonami-isic-2790` is an OSS open-business blueprint for other-
electrical-equipment plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Other Electrical Equipment Plant Operations Governor remains independent of the advisor.

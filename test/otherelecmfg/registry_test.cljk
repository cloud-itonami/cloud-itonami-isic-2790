(ns otherelecmfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [otherelecmfg.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [pt [:welding-equipment :soldering-equipment :appliance-part
              :resistor :capacitor]]
...
;; ----------------------------- insulation-resistance-mohm-valid? -----------------------------

(deftest typical-insulation-resistance-mohm-is-valid
  (is (r/insulation-resistance-mohm-valid? 0.0))
  (is (r/insulation-resistance-mohm-valid? 5.0))
  (is (r/insulation-resistance-mohm-valid? 1000.0))
  (is (r/insulation-resistance-mohm-valid? 200000.0)))

(deftest negative-insulation-resistance-mohm-is-invalid
  (is (not (r/insulation-resistance-mohm-valid? -1.0))))

(deftest excessive-insulation-resistance-mohm-is-invalid
  (is (not (r/insulation-resistance-mohm-valid? 999999999.0)))
  (is (not (r/insulation-resistance-mohm-valid? 200000.01))))

(deftest non-numeric-or-missing-insulation-resistance-mohm-is-invalid
  (is (not (r/insulation-resistance-mohm-valid? nil)))
  (is (not (r/insulation-resistance-mohm-valid? "1000"))))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "assembler-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "assembler-001" 1)

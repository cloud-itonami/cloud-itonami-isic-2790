(ns otherelecmfg.phase
  "Phase 0->3 staged rollout for the ISIC 2790 (other electrical
  equipment: electric welding/soldering equipment, non-electric
  domestic-appliance parts, resistors/capacitors n.e.c.)
  ...
  `otherelecmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Other Electrical Equipment Plant Operations Governor verdict

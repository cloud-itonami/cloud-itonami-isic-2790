# Business Model: Manufacture of other electrical equipment
...
## Classification
- Repository: `cloud-itonami-isic-2790` ([github.com/cloud-itonami/cloud-itonami-isic-2790](https://github.com/cloud-itonami/cloud-itonami-isic-2790))
- ISIC Rev.5: `2790` — Manufacture of other electrical equipment
- Domain: `:electrical-equipment/manufacturing`
- Social impact: :worker-safety :electrical-safety :product-safety
- Actor: `:other-electrical-equipment-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
- Do not bypass the `:other-electrical-equipment-plant-operations-governor` for production decisions.

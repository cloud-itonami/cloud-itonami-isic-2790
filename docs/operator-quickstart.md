# Operator Quickstart — Manufacture of other electrical equipment

Shortest path from clone to a verified local dry-run for **ISIC 2790** (`cloud-itonami-isic-2790`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2790.git
cd cloud-itonami-isic-2790
```
...
- Blueprint governor key: `other-electrical-equipment-plant-operations-governor`
- Likely source path: `otherelecmfg.governor.cljc`
